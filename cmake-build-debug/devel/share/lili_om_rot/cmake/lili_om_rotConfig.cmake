...
if(lili_om_rot_CONFIG_INCLUDED)
  return()
endif()
set(lili_om_rot_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(lili_om_rot_SOURCE_PREFIX /home/ya/lili-om-modify_ws/src/LiLi-OM-ROT)
  set(lili_om_rot_DEVEL_PREFIX /home/ya/lili-om-modify_ws/src/LiLi-OM-ROT/cmake-build-debug/devel)
  set(lili_om_rot_INSTALL_PREFIX "")
  set(lili_om_rot_PREFIX ${lili_om_rot_DEVEL_PREFIX})
else()
  set(lili_om_rot_SOURCE_PREFIX "")
  set(lili_om_rot_DEVEL_PREFIX "")
  set(lili_om_rot_INSTALL_PREFIX /usr/local)
  set(lili_om_rot_PREFIX ${lili_om_rot_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'lili_om_rot' is deprecated")
...
set(lili_om_rot_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/ya/lili-om-modify_ws/src/LiLi-OM-ROT/cmake-build-debug/devel/include;/home/ya/lili-om-modify_ws/src/LiLi-OM-ROT/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(lili_om_rot_INCLUDE_DIRS "")
  set(_include_dirs "/home/ya/lili-om-modify_ws/src/LiLi-OM-ROT/cmake-build-debug/devel/include;/home/ya/lili-om-modify_ws/src/LiLi-OM-ROT/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Kailai Li <kailai.li@kit.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${lili_om_rot_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lili_om_rot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'lili_om_rot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ya/lili-om-modify_ws/src/LiLi-OM-ROT/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lili_om_rot_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND lili_om_rot_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND lili_om_rot_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT lili_om_rot_NUM_DUMMY_TARGETS)
      set(lili_om_rot_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lili_om_rot::wrapped-linker-option${lili_om_rot_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lili_om_rot_NUM_DUMMY_TARGETS "${lili_om_rot_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lili_om_rot::wrapped-linker-option${lili_om_rot_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lili_om_rot_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ya/lili-om-modify_ws/src/LiLi-OM-ROT/cmake-build-debug/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(lili_om_rot_LIBRARY_DIRS ${lib_path})
      list(APPEND lili_om_rot_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'lili_om_rot'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND lili_om_rot_LIBRARIES ${lib})
    endif()
  endif()
...
set(lili_om_rot_EXPORTED_TARGETS "lili_om_rot_generate_messages_cpp;lili_om_rot_generate_messages_eus;lili_om_rot_generate_messages_lisp;lili_om_rot_generate_messages_nodejs;lili_om_rot_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${lili_om_rot_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;message_runtime;std_msgs;nav_msgs;geometry_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 lili_om_rot_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${lili_om_rot_dep}_FOUND)
      find_package(${lili_om_rot_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lili_om_rot_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(lili_om_rot_INCLUDE_DIRS ${${lili_om_rot_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(lili_om_rot_LIBRARIES ${lili_om_rot_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${lili_om_rot_dep}_LIBRARIES})
  _list_append_deduplicate(lili_om_rot_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(lili_om_rot_LIBRARIES ${lili_om_rot_LIBRARIES})

  _list_append_unique(lili_om_rot_LIBRARY_DIRS ${${lili_om_rot_dep}_LIBRARY_DIRS})
  list(APPEND lili_om_rot_EXPORTED_TARGETS ${${lili_om_rot_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "lili_om_rot-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${lili_om_rot_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
